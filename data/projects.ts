    ...
    export const projects: Project[] = [
        {
            slug: 'mafit-butcher-margin-management',
            name: '마핏(MAFIT) 정육점 마진 관리 시스템',
            year: '2026.02 - 2026.05',
            field: '커머스 · 자영업 SaaS · 신규 서비스',
            gradient: 'linear-gradient(135deg, #C0392B 0%, #2C2C2C 100%)',
            tagline: '기획부터 개발, 오픈, 실사용자 검증까지 단독 수행한 사내 신규 서비스',
            summary: '수주 공백기에 사내 결재를 받아 진행한 정육점 대상 원가·마진 관리 서비스로, 기획부터 개발, 정식 오픈, 실사용자 검증까지 전 과정을 단독으로 수행했습니다.',
            overview: '수주 공백 기간 동안 신규 서비스 발굴 목적으로 직접 기획하여 사내 결재 승인을 받아 진행한 프로젝트입니다. 정육점 운영자를 대상으로 공공데이터 기반 시세 정보와 품목별 원가·판매가 마진 계산 기능을 제공하는 웹 서비스를 AI 기반 개발 도구를 활용해 신속하게 구현했고, 정식 오픈까지 마쳤습니다. 오픈 이후 실사용자 인터뷰를 진행한 결과, 정육업 특성상 재고·원가 관리가 수기·경험 기반으로 이루어지는 경우가 많아 서비스 니즈가 낮다는 점을 확인했고, 시장 적합성 부족으로 서비스를 종료했습니다.',
            meta: [
                { k: '역할', v: '기획 · 단독 개발' },
                { k: '기간', v: '4개월' },
                { k: '규모', v: '개발 1인' },
            ...
            contributions: [
                { n: '01', text: '공공데이터 API 연동 및 품목별 시세 데이터 가공, 원가·판매가 기반 마진 계산 기능 설계' },
                { n: '02', text: 'Vue 기반 화면과 Spring Boot API를 AI 기반 개발 도구로 신속 구현, JPA/MyBatis 혼합 구조로 데이터 처리' },
                { n: '03', text: '오픈 후 실사용자 인터뷰를 통해 서비스 니즈 및 시장 적합성 검증' },
            ],
            results: [
                { value: '4개월', label: '기획부터 정식 오픈까지 단독 수행' },
            ],
            tags: ['Java', 'Spring Boot', 'JPA', 'MyBatis', 'Vue.js', 'TypeScript', 'Vite', 'PostgreSQL', 'Claude Code'],
        },
        {
